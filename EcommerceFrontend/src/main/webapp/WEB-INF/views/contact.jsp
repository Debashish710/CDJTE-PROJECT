   ...
   <div class="row">
      ...
      <div class="col-sm-12 col-md-7">
         ...
         <div class="row text-center">
            <div class="col-md-4">
               <a ><i class="fa fa-map-marker" style="font-size:30px;"></i></a>
               <p> Niit Bhubaneswar </p>
            </div>
            <div class="col-md-4">
               <a ><i class="fa fa-phone" style="font-size:30px;"></i></a>
               <p>+91- 90000000</p>
            </div>
            <div class="col-md-4">
               <a ><i class="fa fa-envelope" style="font-size:30px;"></i></a>
               <p> Debashishniit@gmail.com</p>
            </div>
         </div>
      </div>
      <!--Grid column-->
