 <section class="text-center about" style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${img}/bg-2.jpg);  background-position: center; background-size: cover; opacity:80%">
